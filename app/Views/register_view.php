            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <form action="<?= base_url('user') ?>" method="post" enctype="multipart/form-data" class="row g-3 needs-validation">
                        <?= csrf_field(); ?>                        
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <label for="cYourPassword" class="form-label">Password</label>
                                <input type="password" name="cpassword" class="form-control" id="cpassword" placeholder="cpassword" required>
                ...
                <div class="credits">
                    ...
                    <small class="text-muted">Already have an account? <a href="login">Sign in now</a></small>
                </div>
